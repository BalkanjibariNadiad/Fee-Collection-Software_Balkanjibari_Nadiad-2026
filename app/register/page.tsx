...
const SUBJECT_BATCH_TIMINGS: Record<string, string[]> = {
  ...
  'YouTube Training': ['9:00 AM - 10:00 AM'],
  'Spoken English': ['7:00 PM - 8:00 PM'],
  'Skating': ['7:00 AM - 8:00 AM (Morning)', '6:00 PM - 7:00 PM (Batch A)', '7:00 PM - 8:00 PM (Batch B)', '8:00 PM - 9:00 PM (Batch C)'],
  'Badminton': ['6:00 PM - 7:00 PM'],
  'Table Tennis': ['7:00 AM - 8:00 AM (Morning)', '6:00 PM - 7:00 PM (Evening)'],
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 sm:p-6 shadow-xl border border-slate-200 dark:border-slate-800 relative overflow-hidden transition-colors">
          ...
          <div className="space-y-5">
            ...
            <p className="text-center text-gray-400 text-xs">
              Payments are secured by Razorpay. Your account is created instantly after payment.
            </p>
          </div>
        </div>
